...
{
    public class ProjectPaymentTerms2Controller : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: ProjectPaymentTerms2
        public ActionResult Index()
        {
            return View(db.ProjectPaymentTerms.ToList());
        }

        // GET: ProjectPaymentTerms2/Details/5
        ...
        // GET: ProjectPaymentTerms2/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ProjectPaymentTerms2/Create
        ...
        // GET: ProjectPaymentTerms2/Edit/5
        ...
        // POST: ProjectPaymentTerms2/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ProjectPaymentTerms2/Delete/5
        ...
        // POST: ProjectPaymentTerms2/Delete/5
