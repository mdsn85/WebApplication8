...
{
    public class ProjectPaymentTerms1Controller : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: ProjectPaymentTerms1
        public ActionResult Index()
        {
            return View(db.ProjectPaymentTerms.ToList());
        }

        // GET: ProjectPaymentTerms1/Details/5
        ...
        // GET: ProjectPaymentTerms1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ProjectPaymentTerms1/Create
        ...
        // GET: ProjectPaymentTerms1/Edit/5
        ...
        // POST: ProjectPaymentTerms1/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ProjectPaymentTerms1/Delete/5
        ...
        // POST: ProjectPaymentTerms1/Delete/5
