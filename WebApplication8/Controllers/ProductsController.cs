...
namespace WebApplication8.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult IndexShort(string sortOrder, string searchStringName, String searchStringCode, String searchStringBarcode)
        {
            ...
            {
                Products = Products.Where(s => s.Name.Contains(searchStringName, StringComparison.InvariantCultureIgnoreCase));
                search = 1;
            }
        ...
        public JsonResult get(int? id)
        {
            ...
            var material = db.Products.Where(p=>p.ProductId==id).Select(p => new { ProductId = p.ProductId, Name = p.Name }).FirstOrDefault();
